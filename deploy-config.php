 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', 'SoLongAndThanksForAllTheFish');
 ...
 * @var string
 */
define('REMOTE_REPOSITORY', 'https://github.com/oddjones/pipeline');
 ...
 */
define('TARGET_DIR', '/home/pipeline.jonesthecode.com/');
